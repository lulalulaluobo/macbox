...
export const TerminalInputBar: React.FC<TerminalInputBarProps> = ({
  ...
  return (
    <div className="terminal-dark-preserve flex-none space-y-1.5 border-t border-slate-800/90 bg-[#090d16] p-2 pb-[max(0.5rem,env(safe-area-inset-bottom))] sm:space-y-2 sm:p-3 sm:pb-3">
