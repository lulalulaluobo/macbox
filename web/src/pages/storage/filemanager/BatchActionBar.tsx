...
export const BatchActionBar: React.FC<BatchActionBarProps> = ({ visible, selectedCount, onCopy, onCut, onDelete, onDownload }) => {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-[60] grid grid-cols-4 border-t border-slate-200 bg-white px-4 pb-[calc(8px+env(safe-area-inset-bottom))] pt-2 dark:border-slate-700 dark:bg-slate-900 sm:left-1/2 sm:right-auto sm:bottom-6 sm:w-[460px] sm:-translate-x-1/2 sm:rounded-2xl sm:border sm:py-2">
