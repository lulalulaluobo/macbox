        ...
        <div className="w-full max-w-lg space-y-5 rounded-2xl border border-slate-200 bg-white p-6 shadow-2xl dark:border-slate-800 dark:bg-slate-900">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3 dark:border-slate-800">
            <div className="flex items-center space-x-3">
              ...
              <div><h3 className="text-base font-bold text-slate-900 dark:text-white">绑定外接 SSD 为 MacBox 数据盘</h3><p className="text-xs text-slate-500 dark:text-slate-400">{bindingDisk.name} ({bindingDisk.deviceNode})</p></div>
            </div>
          ...
          <div className="space-y-4 text-xs text-slate-700 dark:text-slate-300">
            ...
            <div>
              <label className="mb-1.5 block text-xs font-semibold text-slate-700 dark:text-slate-300">MacBox 本地数据盘上限 (GiB)</label>
